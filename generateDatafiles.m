...
D = 800;               % the dimension of the benchmark functions
...
num_benchmark = 1;     % the number of benchmark functions
num_base = 16;          % the number of base functions
...
for func = 1
    ...
    for i = 1 : num_components
        w(i) = 10 ^ (k * normrnd(mu(index_base(i)), 1));
    end
...
%     save(filename, 'groups');
    ...
    filename=sprintf('./datafiles_2022/%d_f%02d.mat', D, func);
...
max_num = 3;        % Upper limit of reuse of a base function
...
num_shar = D - num_priv;           % the number of shared variables
